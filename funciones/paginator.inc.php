 ...
 */
 ...
 if ($_pagi_actual != 1){
	...
	$_pagi_navegacion_temporal[] = "<a class=\"pagiPrimera\" ".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."'>".$_pagi_nav_primera."</a>";

	// Si no estamos en la página 1. Ponemos el enlace "anterior"
	$_pagi_url = $_pagi_actual - 1; //será el número de página al que enlazamos
	$_pagi_navegacion_temporal[] = "<a class=\"pagiAnterior\"".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."'>".$_pagi_nav_anterior."</a>";
 }
 ...
 for ($_pagi_i = $_pagi_nav_desde; $_pagi_i<=$_pagi_nav_hasta; $_pagi_i++){//Desde página 1 hasta última página ($_pagi_totalPags)
	if ($_pagi_i == $_pagi_actual) {
		...
		$_pagi_navegacion_temporal[] = "<span ".$_pagi_nav_estilo_mod." id=\"pagina_actual\">".$_pagi_i."</span>";
	}else{
 ...
 if ($_pagi_actual < $_pagi_totalPags){
	...
	$_pagi_url = $_pagi_actual + 1; //será el número de página al que enlazamos
	$_pagi_navegacion_temporal[] = "<a class=\"pagiSiguiente\"".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."'>$_pagi_nav_siguiente</a>";
	...
	$_pagi_navegacion_temporal[] = "<a class=\"pagiUltima\"".$_pagi_nav_estilo_mod." href='".$_pagi_enlace."_pagi_pg=".$_pagi_url."'>$_pagi_nav_ultima</a>";
 }
