...
function mostrar_calendario($mes,$ano,$id){
	...
	echo "<a style=color:white;text-decoration:none href=calendario.php?nuevo_mes=$mes_anterior&nuevo_ano=$ano_anterior&id=$id>&lt;&lt;</a></td>";
	...
	echo "<a style=color:white;text-decoration:none href=calendario.php?nuevo_mes=$mes_siguiente&nuevo_ano=$ano_siguiente&id=$id>&gt;&gt;</a></td></tr></table></td></tr>";
	echo '	<tr>
	...
	for ($i=0;$i<7;$i++){
		if ($i < $numero_dia){
			...
			echo "<td></td>";
		  	...
		  	$fecha = $dia_actual."/".$mes."/".$ano;
			echo "<td align=center><a href='#' onclick=DevuelveFecha('$id','$fecha');>$dia_actual</a></td>";
			$dia_actual++;
		}
	}
	echo "</tr>";
