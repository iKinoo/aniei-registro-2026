...
export interface ConstanciaPonenteTemplateProps {
  nombre: string;
  apellido: string;
...
export function ConstanciaPonenteTemplate(props: ConstanciaPonenteTemplateProps) {
  return (
    <Document>
      <Page size="LETTER" orientation="landscape" style={styles.page}>
        ...
        <View style={styles.body}>
          ...
          <Text>
            por su destacada participación en la impartición de la {props.tipoActividad.toLowerCase()} titulada:
          </Text>
