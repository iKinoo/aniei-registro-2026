	...
	<tr>
		...
		<td height="350" colspan=3 valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="ContenidoAniei" --> 
		  ...
		  <table width="600" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
              <td><h1 align="center">Sus datos han sido registrados en nuestra base de datos.</h1>
                <p align="center">&nbsp;</p>
                <p align="center" style="font-size:12px;">Le hemos enviado un correo con la informaci&oacute;n que proporcion&oacute; al<br>
              llenar su solicitud de registro. Le recomendamos descargar su pre-recibo<br>
                para cualquier aclaracion durante el Congreso ANIEI <? echo date("Y"); ?></p>
              <p align="center">&nbsp;</p>
		      <h2 align="center"><a href="cpanel/folio2pdf.php?folio=<?php echo $_GET['folio']; ?>">Descargar mi pre-recibo</a></h2>
		      <p align="center">&nbsp;</p></td>
            </tr>
          </table>
