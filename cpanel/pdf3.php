...
class PDF extends FPDF{
	...
	Function ImprimeDatos( $general_, $foliorecibo){
		...
		$this->Cell(0,0, 'RECIBO' ,0,0,'C');
		$this->ln(12);
	    $this->Cell(60);
		$this->SetFont('arial','B',11);
		$this->Cell(135,0,'Asociación Nacional de Instituciones de Educación en Informática, A.C.',0,0,"R");
		$this->ln(13);
		$this->Cell(50);
		$this->SetFont('arial','B',9);
        $this->Cell(150,0,'XXI Congreso Nacional y VII Congreso Internacional de Informática y Computación de ANIEI',0,0,'L');
		$this->ln(4);
		$this->Cell(50);
        $this->Cell(150,0,'24 al 26 de octubre de 2007, Monterrey, Nuevo León',0,1,'L');
