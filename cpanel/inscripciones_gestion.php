		...
		<td height="350" colspan=3 valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="ContenidoAniei" -->
			...
			<?php
				...
				<tr id="<?php echo $r['id_usuario']; ?>" bgcolor="#<?php echo $color; ?>" onMouseOver="CambiaColor('f8e8a0',id);" onMouseOut="CambiaColor('<?php echo $color; ?>',id);" class="manita">
					...
					<td class="centrar"><a href="inscripciones_gestion2.php?accion=modificar&id_usuario=<?php echo $r['id_usuario']; ?>"><img src="../img/usuarios_modificar.gif" alt="Editar inscripciones" width="16" height="16" border="0"></a></td>
			        <td class="centrar"><a href="inscripciones_gestion2.php?accion=ver&id_usuario=<?php echo $r['id_usuario']; ?>"><img src="../img/recibo.png" alt="Ver inscripciones" width="16" height="16" border="0"></a></td>
					<td class="centrar"><a href="#" onClick="ValidaDeleteUsuario('<? echo $_SERVER['PHP_SELF']; ?>?accion=eliminar&id_usuario=<? echo $r['id_usuario']; ?>');"><img src='../img/usuarios_eliminar.gif' alt="Eliminar inscripciones"  width='16' height='16' border='0'></a></td>
				</tr>
				<?php $i++; } ?>
		</table>
