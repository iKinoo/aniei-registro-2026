...
class PDF extends FPDF{
    ...
    Function ImprimeDatos( $general_, $foliorecibo){
			 ...
			 $this->setXY(53,55);
		     $this->MultiCell(97,3,$general_[0]." ".$general_[1],0,'');
			 $this->setXY(53,71);
			 if( $general_[5] == 0){ $nom_ins_ = $general_[6];}
		     else{ $nom_ins_ = $general_[7];}					      
			 $this->MultiCell(100,3,$nom_ins_ ,0,1,'J');
	         $this->setXY(53,105);			 
			 $nom_ins_ = cantidadletra($general_[8] );		  
		    $this->MultiCell(100,4,"Son: ".$nom_ins_." pesos 00/100 M.N.",0,'');
	...
	Function ImprimeDatosYANO( $general_, $foliorecibo){
