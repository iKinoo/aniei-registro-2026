<?php
	...
	mysql_query("COMMIT;");	
		...
		if($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['no'])) 
                    header("Location: InterfazEdicionUsuario.php");
	}
?>
		...
		<td height="350" colspan=3 valign="top" bgcolor="#FFFFFF"><!-- InstanceBeginEditable name="ContenidoAniei" -->
			...
			<table align="center">
				<tr>
					<td align="center">
					<p class="centrar"><br>
					    &iquest;Est&aacute; seguro que desea eliminar al Usuario?</p>
					<p class="centrar"> NOTA: Se eliminar&aacute;n todos los datos asociados,<br>
						as&iacute; como su informaci&oacute;n de dep&oacute;sitos y facturaciones. </p>
					<form name="form1" method="post" action="../falloEliminarUsuarioX.php">
			...
			<p class="centrar"><a href="usuarios_gestion.php">Regresar</a></p>
			<p class="centrar">&nbsp;</p>
