...
<table border="0" align="center" cellpadding="0" cellspacing="0">
	...
	<tr>
		...
		<p align="center" class="centrar"><b>Monterrey, Nuevo Le&oacute;n, M&eacute;xico</b></p><p>&nbsp;</p>
		<table width="600" align="center">
			<tr><td align="center">	<p class="centrar">El usuario con folio <?php echo $_SESSION['temp_id']; ?>: <?php echo $_SESSION['temp_nombre']; ?> se ha registrado</p></td><tr>
			<tr><td><h2 align="center"><a href="pdf2.php?xkyyx=<?php echo $_SESSION['temp_recibo']; ?>">Imprimir recibo de inscripci&oacute;n</a></h2></td></tr>
		</table>
		<? $_SESSION["temp_id"] = "";
		$_SESSION['temp_nombre'] = "";
		$_SESSION['temp_recibo'] = "";
		
		/*$men=fopen("mensaje.txt", "r");
		$mensaje= (string)fread($men,200);
		fclose($men);
		echo $mensaje; */ ?>
		<p class="centrar"><a href="interfazUsuarios.php">Regresar </a></p>
